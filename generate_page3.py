...
# Generate TS for Page 3 (ID 84 to 75)
# Indices: 20 to 30 (Exclusive)
start_idx = 20
end_idx = 30

if total_count >= end_idx:
    page_raw = raw_reviews[start_idx:end_idx]
    
    ts_output = ""
    
    for i, qa_list in enumerate(page_raw):
    ...
    with open('page3_snippet.ts', 'w', encoding='utf-8') as f:
        f.write(ts_output)
    print("Generated page3_snippet.ts")
else:
    print(f"Not enough reviews for page 3. Total: {total_count}")
