          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16">
            ...
            <div className="md:hidden w-full mb-6">
               <div className="flex items-end justify-between gap-2">
                  <div className="w-2/3">
                    <div className="inline-block bg-blue-600/10 text-blue-600 font-bold px-3 py-1 rounded-full text-[10px] mb-3 border border-blue-600/20 leading-tight">
                      社員10〜150名の<br/>人手不足の企業にオススメ
                    </div>
               ...
               <div className="flex items-center gap-3 mb-3">
                  ...
                  <h1 className="text-sm font-bold text-gray-400 tracking-widest">AI基礎研修</h1>
                  <div className="h-px bg-gray-300 flex-grow"></div>
               </div>
            ...
            <div className="md:hidden w-full">
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                {[
                  ...
                  <div key={i} className="bg-blue-50/50 rounded-lg p-2 text-center border border-blue-100 relative pt-5">
                    ...
                    <p className={`text-blue-600 font-black leading-tight ${item.isText ? 'text-xs' : 'text-lg'}`}>
                      {item.isText ? '超実践的' : item.main}
                    </p>
                  </div>
                ))}
              </div>
              <p className="text-blue-600 font-bold text-center text-xs mb-6">
                社員10〜150名、人手不足の企業にオススメ
              </p>
              ...
              <div className="flex flex-col items-center gap-3">
                  <Link 
                    href="https://general-cg.com/contact/" 
                    className="inline-flex items-center justify-center w-full bg-blue-600 text-white font-bold py-4 rounded-full shadow-lg text-lg animate-pulse"
                  >
                    AI基礎研修の話を聞く
                  </Link>
