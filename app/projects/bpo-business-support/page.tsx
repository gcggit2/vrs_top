...
export const metadata: Metadata = {
  title: 'BPO業務支援企業｜支援事例｜ジェネラルコンサルティンググループ',
  description: 'ジェネラルコンサルティンググループの支援事例詳細ページです。BPO業務支援企業の課題解決プロセスと成果をご紹介します。',
};

export default function BpoBusinessSupportProject() {
  return (
      ...
      <section className="pt-8 pb-12 md:pt-12 md:pb-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl max-w-md mx-auto">
                <img 
                    src="/projects/bpo-business-support/bpo-business-support.jpg" 
                    alt="BPO業務支援企業" 
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div>
            ...
            <div className="leading-loose text-gray-700">
              <p className="mb-6">
                企業の特定業務部門を巻き取って代行するサービス（BPOサービス）を提供する企業です｡
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div>
            ...
            <div className="space-y-8 leading-loose text-gray-700">
              <p>
                BPO業務支援企業のマーケティングソリューション部門に対し、AI活用の実践研修を実施いたしました。
              </p>
              <p>
                <span className="font-bold underline decoration-brand-red decoration-2 underline-offset-1">マーケティング施策の企画立案、メルマガやホワイトペーパーの作成、数値分析</span>といった業務をAIで効率化する方法を取り扱い｡さらには､<span className="font-bold underline decoration-brand-red decoration-2 underline-offset-1">契約書の作成・チェック業務もAIで半自動化</span>できるようになりました｡
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="bg-gray-50 px-6 py-4 border-b border-gray-100">
                    <h3 className="font-bold text-gray-900 text-center">マーケティング業務時間</h3>
                  </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                  <div className="bg-gray-50 px-6 py-4 border-b border-gray-100">
                    <h3 className="font-bold text-gray-900 text-center">スタッフの稼働</h3>
                  </div>
                  <div className="p-6 flex flex-col gap-6">
                    {/* Before */}
                    <div className="bg-gray-50 rounded-lg p-4 relative">
              ...
              <p>
                研修を通じて、<span className="font-bold underline decoration-brand-red decoration-2 underline-offset-1">従来のマーケティング業務に要する時間は約50％短縮</span>｡
              </p>
              <p>
                新たな戦術・企画立案や他業務へリソースを振り向けられるようになりました｡
              </p>
            </div>
          </div>
        </div>
