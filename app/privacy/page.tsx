...
export const metadata: Metadata = {
  title: 'プライバシーポリシー｜ジェネラルコンサルティンググループ',
  robots: {
    index: false,
  },
};
    ...
    <main className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="bg-gray-50 py-16 md:py-24 border-b border-gray-100">
        <div className="container mx-auto px-4 text-center">
          <span className="text-brand-red font-bold tracking-widest block mb-2">PRIVACY POLICY</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12">
            <div className="prose prose-red max-w-none text-gray-700 leading-relaxed">
              <p className="mb-8">
                ジェネラルコンサルティンググループ株式会社（以下、当社といいます。）は、皆様の個人情報の重要性を認識し、その適正な収集、利用、保護をはかるとともに、安全管理を行うため、プライバシーポリシーを定め、次のとおり運用します。
              </p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の定義</h2>
              <p>個人情報とは、利用者個人に関する情報であって、当該情報を構成する氏名、メールアドレス、生年月日その他の記述等により当該利用者を識別できるものとします。</p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の利用目的</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の第三者提供</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の安全管理</h2>
              <p>当社が提供するサービス全般)の従業員に対する教育を行い、個人情報保護を徹底します。</p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の変更等</h2>
              <p>当社が提供するサービス全般)において登録した個人情報をいつでも変更・追加・削除することができます。</p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">個人情報の利用目的の通知、開示、利用停止等の求め</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">お問い合わせ窓口</h2>
              <p>開示等のお申出、ご意見、ご質問、苦情、その他個人情報の取り扱いに関するお問い合わせは、<a href="mailto:info@general-cg.com" className="text-brand-red hover:underline">info@general-cg.com</a> にご連絡ください。</p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">免責</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">cookie(クッキー)の使用</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">アクセスログ等の記録、開示</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">統計データの利用</h2>
              <p>当社が提供するサービス全般)は、提供を受けた個人情報をもとに、個人を特定でけない形式による統計データを作成し、当該データにつき何らの制限なく利用することができるものとします。</p>

              <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 border-l-4 border-brand-red pl-4">継続的改善</h2>
              <p>当社(およびジェネラルコンサルティンググループ株式会社が提供するサービス全般)は、個人情報の取り扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、プライバシーポリシーを変更することがあります。</p>
              
              <p className="mt-12 text-right font-bold">2023年3月1日 制定</p>
            </div>
          </div>
        </div>
      </section>
